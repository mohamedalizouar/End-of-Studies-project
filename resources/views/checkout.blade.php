            ...
            <div class="col-lg-8">
                <form class="needs-validation" method="POST" action="place-order">
                    ...
                    <div id="billingAddress" class="row g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select custome-form-select" id="country" name="country">
                                <option>l’Afghanistan</option>
                                <option>l’Afrique du Sud </option>
                                <option>l’Algérie </option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select custome-form-select" id="state" name="state">
                                ...
                                <option selected="" disabled="" value="">Choose...</option>
                                <option value="Andhra Pradesh">sfax</option>
                                <option value="Arunachal Pradesh">tunis</option>
                                <option value="Assam">paris</option>
                                <option value="Bihar">lyon</option>
                                <option value="Chhattisgarh">rablos</option>
                    ...
                    <div id="shippingAddress" class="row g-4 mt-5">
                        ...
                        <div class="col-md-3">
                            <label for="zip" class="form-label">Zip</label>
                            <input type="text" class="form-control" id="s_zip" name="s_zip" placeholder="******">
                        </div>
                    </div>
                    ...
                    <a href="{{route('thankyou.index')}}" class="btn btn-solid-default btn fw-bold">
                        Place Order <i class="fas fa-arrow-right ms-1"></i></a>
            ...
            <div class="col-lg-4">
                <div class="your-cart-box">
                    <h3 class="mb-3 d-flex text-capitalize">Your cart
                        ...
                        {{-- <span class="badge bg-theme new-badge rounded-pill ms-auto bg-dark">0</span> --}}
                    </h3>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed active">
                            <div class="text-dark"> 
                                    ...
                                    <span>
                                        ...
                                        {{cart::instance('card')->tax()}} TND </span>
