...
<section class="pt-0 poster-section">
    ...
    <div class="left-side-contain">
        <div class="banner-left">
            <h4>Sale <span class="theme-color">50% Off</span></h4>
            <h1>New Latest <span>Dresses</span></h1>
            <p>BUY ONE GET ONE <span class="theme-color">FREE</span></p>
            <h2>40.00DT<span class="theme-color"><del>80.00</del>DT</span></h2>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="collection-banner p-bottom p-center text-center">
                    ...
                    <div class="banner-detail">
                        ...
                        <span class="font-dark-30">30% <span>OFF</span></span>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="collection-banner p-bottom p-center text-center">
                    ...
                    <div class="banner-detail">
                        ...
                        <span class="font-dark-30">20% <span>OFF</span></span>
                    </div>
                    <a href="{{route('shop.index')}}" class="contain-banner">
                        <div class="banner-content with-big">
                ...
                <div class="product-box">
                    <div class="img-wrapper">
                        ...
                        <div class="label-block">
                            <span class="label label-theme">3% Off</span>
                        </div>
                        <div class="cart-wrap">
                            <ul>
                                <li>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">50DT</div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">30DT</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">80DT</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">20DT</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">70DT</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">15DT</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                ...
                <div>
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="label-block">
                                <span class="label label-theme">440% Off</span>
                            </div>
                            <div class="cart-wrap">
                                <ul>
                                    <li>
