                                ...
                                <div class="row">
                                    <div class="col-lg-2"> 
                                        <div class="details-image-vertical black-slide rounded">
                                            <div>
                                                <img src="{{ asset('assets/images/fashion/product/front') }}/{{ $produit->image }}"
                                                    class="img-fluid blur-up lazyload" alt="{{ $produit->name }}">
                                            </div>
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{route('shop.produit.details',['slug'=>$rproduit->slug])}}">
                                            <img src="{{asset('assets/images/fashion/product/front')}}/{{$rproduit->image}}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="{{route('shop.produit.details',['slug'=>$rproduit->slug])}}">
                                            <img src="{{asset('assets/images/fashion/product/back')}}/{{$rproduit->image}}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="{{route('shop.produit.details',['slug'=>$rproduit->slug])}}" class="font-default">
                                            <h5>{{$rproduit->name}}</h5>
                                        </a>  
                                        <div class="listing-content">
                                            @if($rproduit->categori)
                                            <span class="font-light">{{$rproduit->categori->name}}</span>  
                                        @else
                                            <span class="font-light">Catégorie non définie</span>
                                        @endif                                            
                                        <p class="font-light">{{$rproduit->short_description}}</p>
                                        </div>
                                        <h3 class="theme-color">@if($rproduit->sale_price) {{$rproduit->sale_price}} @else {{$rproduit->regular_price}} @endif TND </h3>
