                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <li class="nav-menu">
                                            ...
                                            <li><a href="{{route('app.index')}}" class="nav-link menu-title text-dark" > <strong>HOME</strong> </a></li>
                                            <li><a href="{{route('shop.index')}}" class="nav-link menu-title text-dark"><strong>SHOP</strong> </a></li>
                                            <li><a href="{{route('card.index')}}" class="nav-link menu-title text-dark"><strong>CART</strong></a></li>
